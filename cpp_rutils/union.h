...
std::vector<typename In::value_type> union_vc(const In& v1, const In& v2, Compare comp)
{
  ...
  std::set_union(v1.begin(), v1.end(), v2.begin(), v2.end(), std::back_inserter(res), comp);
  return res;
}
...
std::vector<typename std::invoke_result_t<Fun, typename In::value_type>> union_vc_fun(const In& v1,
                                                                                      const In& v2,
                                                                                      Fun       fun,
                                                                                      Compare comp)
{
